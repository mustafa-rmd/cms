...
public class ImportJobQueueConfig {
  ...
  public DirectExchange importJobExchange() {
    ...
    return ExchangeBuilder.directExchange(importExchange).durable(true).build();
  }
  ...
  public Binding importJobBinding() {
    return BindingBuilder.bind(importJobQueue()).to(importJobExchange()).with(importRoutingKey);
  }

  @Bean
  public Binding importJobDlqBinding() {
    return BindingBuilder.bind(importJobDlq()).to(importJobExchange()).with("import.failed");
  }

  @Bean
  public Binding importJobRetryBinding() {
    return BindingBuilder.bind(importJobRetryQueue()).to(importJobExchange()).with("import.retry");
  }
